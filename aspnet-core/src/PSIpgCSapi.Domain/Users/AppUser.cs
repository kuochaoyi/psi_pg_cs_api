...
namespace PSIpgCSapi.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update PSIpgCSapiDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update PSIpgCSapiEfCoreEntityExtensionMappings to extend the IdentityUser entity
